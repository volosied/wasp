...
public class JspConfig {
    ...
    private void processWebDotXml(ServletContext ctxt) throws WaspException {
     ...
     */
    public JspProperty findJspProperty(String uri) throws WaspException {
     ...
     * for jspc.
     */
    public boolean isJspPage(String uri) throws WaspException {
